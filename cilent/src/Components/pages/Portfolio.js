        ...
        <div className="container-fluid p-0">
            ...
            <div className="portfolio-section">
                ...
                <div className="row portfolio-section-box">
                    ...
                    {/* <div class="portfolio-section-box-1">
                        <img src="/Images/portfolio/android/and1.jpg"  alt="Avatar" class="image" />
                        <h6>Stock Management</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
                    </div> */}
                    ...
                    <div className="portfolio-section-box-1" id="android2">  
                        <img src="/Images/portfolio/android/and2.jpg" alt="Avatar" class="image"/>
                        <h6>Track 927</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
                    ...
                    <div className="portfolio-section-box-1" id="android3">
                        <img src="/Images/portfolio/android/and3.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android4">
                        <img src="/Images/portfolio/android/and4.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android5">
                        <img src="/Images/portfolio/android/and5.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android6">
                        <img src="/Images/portfolio/android/and6.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android7">
                        <img src="/Images/portfolio/android/and7.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android8">
                        <img src="/Images/portfolio/android/and8.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android9">
                        <img src="/Images/portfolio/android/and9.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="android10">
                        <img src="/Images/portfolio/android/and10.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native1">
                        <img src="/Images/portfolio/React_Native/RN1.jpg" alt="Avatar" class="image"/>
                        <h6>Golf App</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native2">
                        <img src="/Images/portfolio/React_Native/RN2.jpg" alt="Avatar" class="image"/>
                        <h6>Stories App</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native3">
                        <img src="/Images/portfolio/React_Native/RN3.jpg" alt="Avatar" class="image"/>
                        <h6>jewellers App</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native4">
                        <img src="/Images/portfolio/React_Native/RN4.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native5">
                        <img src="/Images/portfolio/React_Native/RN5.jpg" alt="Avatar" class="image"/>
                        <h6>Nturition App</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native6">
                        <img src="/Images/portfolio/React_Native/RN6.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native7">
                        <img src="/Images/portfolio/React_Native/RN7.jpg" alt="Avatar" class="image"/>
                    ...
                    <div className="portfolio-section-box-1" id="React_Native8">
                        <img src="/Images/portfolio/React_Native/RN8.jpg" alt="Avatar" class="image"/>
                        <h6>Book Store</h6>
                        <div class="middle">
                            <div class="text"><a href="" target="_blank"><i class="fas fa-link"></i></a></div>
                        </div>
